...
from .views import ActivePlanView, GeneratePlanView, RegeneratePlanView, WorkoutDayDetailView, RecentAdjustmentsView
...
urlpatterns = [
    ...
    path("adjustments/recent/", RecentAdjustmentsView.as_view(), name="recent-adjustments"),
]